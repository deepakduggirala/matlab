function proj_v0_0_2(nL)
%D,C,V are big matrices. Donot iterate for each link
...
%torque as a function of time and on all links
    tau = 5;
end
...
for i=1:nL+1
    str = num2str(i);
    text(coords(i,1),coords(i,2),coords(i,3),str)
end
end