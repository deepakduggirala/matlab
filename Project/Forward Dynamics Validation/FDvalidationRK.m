function FDvalidationRK(NB,report)
...
%--------------------------------------------------------------------------
%settings
myPath = genpath('C:\Users\deep\Documents\MATLAB\project\Forward Dynamics Validation\Solvers\LE with complete RNEA');
refDataFileName = 'L3_3D_CoMpos_e_3_1s.tab';   %filename of reference data
...
if(strcmp(refDataFileName,'') == 0)
    numSteps_ref = (e_ref/t_ref)+1;
    ref = zeros(numSteps_ref,3,NB);     %reference data matrix
